...
namespace WordSearch.Tests.Common
{
    public class TestUtilities
    {
        ...
        public static string TEST_PUZZLES_DIRECTORY = $"tests{Path.DirectorySeparatorChar}testpuzzles";
        public static string EMPTY_DIRECTORY = $"tests{Path.DirectorySeparatorChar}emptydirectory";
